...
* Replace all less than characters with the corresponding HTML entity.
* Never change user input, but add a validation error if the input contains the less than character.
